		    ...
		    <div class="header"> 
                <h1 class="page-header">
				    ...
				    <ol class="breadcrumb">
					  ...
					  <li class="active">Faktura izlaza robe</li>
					</ol> 
            ...
            <div class="row"> 
                <div class="col-md-6 col-sm-12 col-xs-12">                     
                    <div class="panel panel-default">
                        ...
                        <form name='formInsert' method='POST' action='fakturaIzlazAjax.php' id='formInsert'  class='fakturaForm'>
