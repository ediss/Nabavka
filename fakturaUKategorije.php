		    ...
		    <div class="header"> 
                <h1 class="page-header">
				    ...
				    <ol class="breadcrumb">
					  ...
					  <li class="active">Faktura po kategorijama</li>
					</ol> 
            ...
            <div class="row"> 
                <div class="col-md-6 col-sm-12 col-xs-12">                     
                    <div class="panel panel-default">
                        ...
                        <form name='formInsert' method='POST' action='fakturaUKategorijeAjax.php' id='formInsert'  class='fakturaForm'>
                            ...
                            <script type="text/javascript">
                                ...
                                $(document).ready(function() {
                                    $("#formInsert").submit(function() {		
                                        $.ajax({
                                            type: "POST",
                                            url: 'fakturaUKategorijeAjax.php',
